...
const styles = StyleSheet.create({
  ...
  qBlock: { marginBottom: 10, paddingLeft: 10, borderLeftWidth: 2 },
  q: { fontWeight: 700, marginBottom: 2, fontSize: 10.5 },
  a: { lineHeight: 1.5, color: "#374151" },
  tag: { fontSize: 8, color: "#9CA3AF", marginTop: 2 },
  ...
  return (
    ...
    >
      ...
      <Page size="A4" style={styles.page}>
        ...
        <Text style={styles.footer}>Prepared for {content.leadName} · Scaler · This brief was generated from your call notes</Text>
      </Page>
    </Document>
  );
}
